...
public class UpdateUserOperationClaimCommandHandler : ICommandHandler<UpdateUserOperationClaimCommand, UserOperationClaim>
{
    ...
    public async Task<ServiceResponse<UserOperationClaim>> Handle(UpdateUserOperationClaimCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            return ServiceResponse<UserOperationClaim>.FailureDataWithMessage(Messages.RecordIsNotFound, new Error(MessageCode.RecordIsNotFound, Messages.RecordIsNotFound));
        }
