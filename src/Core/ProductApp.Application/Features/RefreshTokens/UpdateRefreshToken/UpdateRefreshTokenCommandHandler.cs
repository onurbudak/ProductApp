...
public class UpdateRefreshTokenCommandHandler : ICommandHandler<UpdateRefreshTokenCommand, RefreshToken>
{
    ...
    public async Task<ServiceResponse<RefreshToken>> Handle(UpdateRefreshTokenCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            return ServiceResponse<RefreshToken>.FailureDataWithMessage(Messages.RecordIsNotFound, new Error(MessageCode.RecordIsNotFound, Messages.RecordIsNotFound));
        }
